        ...
        <div id="middleMenubar">
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        <li id="save"><a href="#"
                                         onclick="getContent(),formSubmit('insert.action?state=1','_self');">发布</a></li>
                        <li id="save"><a href="#"
                                         onclick="getContent(),formSubmit('insert.action?state=2','_self');">草稿</a></li>
        ...
        <div>
            <div>
                <table class="commonTable" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="tableContent"><select name="rankId"
                            ...
                            <c:forEach items="${rankList}" var="r">
                                <option value="${r.id}">${r.rankName}</option>
                            </c:forEach>
                        </select> <input type="hidden" id="rankName" name="rankName" value=""/></td>
                    </tr>
                    <tr style="height: 10px">
                    </tr>
                    <tr>
                        <td class="columnTitle_mustbe">课程名：</td>
                        <td class="tableContent"><input type="text" maxlength="15"
                                                        name="courseName" placeholder="15字以内"/><br/></td>
                    </tr>
                    <tr style="height: 10px">
                    </tr>
                    <tr>
                        <td class="columnTitle_mustbe">课程摘要：</td>
                        <td class="tableContent"><input type="text" maxlength="32"
                                                        name="courseAbstract" placeholder="32字以内"/><br/></td>
                    </tr>
                    <tr style="height: 10px">
                    </tr>
                    <tr>
                        ...
                        <td class="tableContent"><input type="file"
                                                        name="courseCover" id="pic_file"/> <font
                                color="red">推荐尺寸400*300，次之长宽比4:3</font></td>
                    </tr>
                    <tr style="height: 10px">
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="columnTitle_mustbe">课程备注：</td>
                    </tr>
                    <tr style="height: 10px">
                    </tr>
                    <tr>
                        <td></td>
                        <td><input type="hidden" name="courseRemark" id="courseRemark" maxlength="1000"/><textarea
                                name="courseRemark1" id="courseRemark1"
                                onchange="crchange()" style="height: 120px; width: 300px"></textarea></td>
                    </tr>
                    <tr>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <textarea
                                    name="courseContent" rows="5" cols="20" style="display: none" maxlength="500000"
                                    id="txt"></textarea></td>
                    </tr>
                </table>
            </div>

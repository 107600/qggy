        ...
        <div class="panel-header">
            ...
            <div class="panel-content">
                <ul>
                    ...
                    <li><a href="${ctx}"
                           onclick="linkHighlighted(this)" target="main" id="aa_1">申请管理</a>
                    </li>


                    <li><a href="${ctx}/"
                           onclick="linkHighlighted(this)" target="main" id="aa_1">导师管理</a>
                    </li>
                    <li><a href="${ctx}/"
                           onclick="linkHighlighted(this)" target="main" id="aa_1">匠人管理</a>
                    </li>

    ...
    <div class="textbox-header">
        <div class="textbox-inner-header">
            ...
            <div class="textbox-title">
                ...
                活动主题:<input type="text" name="likes" id="likes" value="${likes}">
                活动类型:<input type="text" name="likes" id="likes" value="${likes}">
                活动状态:<input type="text" name="likes" id="likes" value="${likes}">
                ...
                <table id="ec_table" class="tableRegion" width="98%">
                    ...
                    <c:forEach  items="${activitys}" var="activity">
                        <tr>
                            ...
                            <td>
                                <a href="#" onclick="formSubmit('view.action','_self');this.blur();" target="_Blank">查看详细信息</a>

                ...
                <div>
                    <table class="commonTable" cellspacing="1">
                        <tr>
                            ...
                            <td class="tableContent"><select onchange="setAreaLevel(this.options[this.selectedIndex].value);">
                        ...
                        <tr id="tr1">
                            ...
                            <td class="tableContent">
                                <select id="firstSelect" onchange="setFirstParent(this.options[this.selectedIndex].value);">
                        ...
                        <tr>
                            ...
                            <td class="tableContent"><textarea name="areaRemark" style="height: 120px;" maxlength="200"></textarea></td>
                        </tr>

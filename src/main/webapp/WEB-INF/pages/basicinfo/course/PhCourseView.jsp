        ...
        <div class="content">
            ...
            <div class="index_search"
                ...
                <div class="starting js_depart">
                    ...
                    <span class="chooseArea" id="${area.id }" title="����л�">${area.areaName}</span>
                </div>
            </div>
...
<script>
    ...
    (function () {
        ...
        container.style.height = document.body.clientWidth * 3 / 4 + "px";
    ...
    //var data1=[{"courses":[{"categoryid":1,"classtime":"","contentn":"�������֯��顿�Ϻ�������Ӵ�ͳ�Ļ��ٽ����ģ����Ϻ����׼Ҿ����Ĺ�֡������������������Ĵ�ͳ","courseid":0,"cover":"img/1.jpg","level":1,"pdf":"34354","pricemoney":301,"time":null,"title":"301"},{"categoryid":1,"classtime":"","contentn":"�������֯��顿�Ϻ�������Ӵ�ͳ�Ļ��ٽ����ģ����Ϻ����׼Ҿ����Ĺ�֡������������������Ĵ�ͳ","courseid":0,"cover":"img/1.jpg","level":2,"pdf":"345","pricemoney":301,"time":null,"title":"301"}],"xianmgu":"301�ƻ�"},{"courses":[{"categoryid":2,"classtime":"","contentn":"�������֯��顿�Ϻ�������Ӵ�ͳ�Ļ��ٽ����ģ����Ϻ����׼Ҿ����Ĺ�֡������������������Ĵ�ͳ","courseid":0,"cover":"img/1.jpg","level":1,"pdf":"2342","pricemoney":801,"time":null,"title":"801"},{"categoryid":2,"classtime":"","contentn":"�������֯��顿�Ϻ�������Ӵ�ͳ�Ļ��ٽ����ģ����Ϻ����׼Ҿ����Ĺ�֡������������������Ĵ�ͳ","courseid":0,"cover":"img/1.jpg","level":1,"pdf":"456��","pricemoney":801,"time":null,"title":"801"},{"categoryid":2,"classtime":"","contentn":"�������֯��顿�Ϻ�������Ӵ�ͳ�Ļ��ٽ����ģ����Ϻ����׼Ҿ����Ĺ�֡������������������Ĵ�ͳ","courseid":0,"cover":"img/1.jpg","level":2,"pdf":"3453","pricemoney":801,"time":null,"title":"801"}],"xianmgu":"801"}];
            ...
            for (var j = 0; j < data1[i].courses.length; j++) {
                ...
                if (0 ==${area.id}) {
                    li.innerHTML = "<a href=phonecoursedetail.action?id="
                        ...
                        + "</h2><p style='font-size:0.6rem' >" + data1[i].courses[j].areaName + "&nbsp;&nbsp;"

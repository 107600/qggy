...
<div class="my-from" style="width: 100%; height: 100%">
    <div class="my-title"
         style="font-size: 60px; height: 5%; margin-top: 5%;">
        <h5 style="font-size: 60px">确认订单信息</h5>
    </div>
    ...
    <div class="my-pic-title " style="height: 100px">
        <div
                style="text-align: left; margin-left: 10%; font-size: 30px; margin-top: 40px;">购买数量(个)
        </div>
        <div style="text-align: center; font-size: 30px; margin-top: 40px;">总价</div>
    </div>

    <div class="my-pic-content">
        <div class="my-item">
            <label class="my-radio" style="font-size: 20px">
                ${jspay.amount} </label> <span class="my-item-money"
                                               style="font-size: 20px"> ${jspay.amount*course.coursePrice}
        </span>
        </div>
    ...
    <div id="dtbg" class="my-user-message" style="margin-left: 10%; font-size:30px">
        <table id="tb_teamUser">
            <tr>
                <td width="30%">真实 姓名</td>
                <td width="50%">手机号</td>
                <td width="50%">微信号</td>
            </tr>
            ...
            <c:forEach items="${jspay.studentlist}" var="o" varStatus="status">
                <tr>
                    ...
                    <td style="height:50px ;width:25%">${o.userName}</td>
                    <td style="height:50px ;width:25%">${o.phoneNumber}</td>

                    <td style="height:50px ;width:25%">${o.weiXin}</td>
    ...
    <div class="my-pic-title " style="height: 100px">
        <div
                style="text-align: left; margin-left: 10%; font-size: 30px; margin-top: 40px;">留言信息
        </div>
...
<script>
    ...
    } else if (window.opener && window.opener.location.href) {
        thisRefer = document.opener.location.href;
    } else if (window.parent && window.parent.location.href) {
        thisRefer = window.parent.location.href
    }
    document.getElementById('fromUrl').value = thisRefer;
</script>
